...
### 🧮 Calculatrice
Calculatrice en ligne de commande gérant les opérations de base.

### 🎲 Lancer de dés
Simulation de lancers de dés avec gestion des probabilités.

### 🔢 Jeu du nombre mystère
Le programme choisit un nombre aléatoire, le joueur doit le deviner
avec des indices (plus grand / plus petit).

### ⚔️ Jeu de rôle
Mini RPG en mode texte avec gestion de personnages et combats.

## Technologies
- Langage : Python
- Développement : 100% autodidacte
